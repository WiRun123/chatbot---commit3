...
namespace CyberSecChatbox
{
    internal class Program
    {
        ...
        {
            // ASCII Art with a colorful border
            PrintBorder();
            ...
            // Configure Speech Synthesizer for higher quality audio
            ...
            PrintDecoratedMessage(greeting);
            ...
            PrintDecoratedMessage(personalizedGreeting);
            synth.Speak(personalizedGreeting);


            while (true)
            {
                PrintDecoratedMessage("What would you like to know about cybersecurity? (Type 'exit' to quit)");
            ...
            PrintDecoratedMessage("Goodbye! Stay safe online.");
        ...
        // Method to print out colorful text
       static void PrintDecoratedMessage(string message)
        {
